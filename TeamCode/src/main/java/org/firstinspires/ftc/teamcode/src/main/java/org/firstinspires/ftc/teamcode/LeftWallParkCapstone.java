...
@Autonomous(name="LeftWallParkCapstone", group="WallPark")
public class LeftWallParkCapstone extends AutonDriving {
    ...
    public void runOpMode()
    {
        ...
        //
        //was 18
        encoderDrive(46,"f", 5, driveSpeed);
        robot.claw.setPosition(clawOpen);
        encoderDrive(28,"b",10,1);
